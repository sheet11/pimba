...
<div class="bd-example">
  <div class="btn-group">
    <button type="button" class="btn btn-primary btn-sm btn-flat">Primary</button>
  ...
  <div class="btn-group">
    <button type="button" class="btn btn-danger btn-sm btn-flat">Danger</button>
...
<div class="dropdown-menu">
  <form class="px-4 py-3">
    ...
    <button type="submit" class="btn btn-primary btn-sm btn-flat">Sign in</button>
  </form>
  <div class="dropdown-divider"></div>
