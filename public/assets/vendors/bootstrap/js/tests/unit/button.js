$(function () {
  ...
  QUnit.test('should not add aria-pressed on labels for radio/checkbox inputs in a data-toggle="buttons" group', function (assert) {
    assert.expect(2)
    var groupHTML = '<div class="btn-group" data-toggle="buttons">' +
      '<label class="btn btn-primary btn-sm btn-flat"><input type="checkbox" autocomplete="off"> Checkbox</label>' +
      '<label class="btn btn-primary btn-sm btn-flat"><input type="radio" name="options" autocomplete="off"> Radio</label>' +
      '</div>'
    var $group = $(groupHTML).appendTo('#qunit-fixture')
