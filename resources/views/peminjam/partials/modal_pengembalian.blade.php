<div class="modal fade" id="modalPengembalian">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('peminjam.pengembalian') }}" method="POST" class="form">
                {{ csrf_field() }} {{ method_field('PATCH') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Pengembalian</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="pengembalian_id" id="pengembalian_id_pengembalian">
